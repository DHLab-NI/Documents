...
report 50182 "DHLab Sales Invoice"
{
    ...
    dataset
    {
        ...
        dataitem(Header; "Sales Invoice Header")
        {
            ...
            column(DueDate_Header; format("Due Date", 0, '<day,2>/<month,2>/<year4>'))
            {
            }
            ...
            begin
                ...
                FormatAddr.SalesInvBillTo(BillToAddress, Header);
                FormatAddr.SalesInvShipTo(ShipToAddress, BillToAddress, Header);
                ...
                if (Header."Bill-to Country/Region Code" = 'IE') then begin
                    VatText := 'This invoice is subject to the reverse charge in Ireland to account for Irish VAT';
                end;
    ...
    labels
    {
        SalesInvoice_Document_Caption = 'Sales Invoice';
    }

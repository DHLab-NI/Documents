    ...
    dataset
    {
        dataitem("Sales Cr.Memo Header"; "Sales Cr.Memo Header")
        {
            ...
            begin
                ...
                FormatAddr.SalesCrMemoBillTo(BillToAddress, "Sales Cr.Memo Header");
                ...
                //Calculate Total Invoice VAT Amount
                TotalVAT := "Sales Cr.Memo Header"."Amount Including VAT" - "Sales Cr.Memo Header".Amount;

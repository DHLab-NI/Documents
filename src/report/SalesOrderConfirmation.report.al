// DHLab Sales Order Confirmation
// SGH 26/02/2025
report 50184 "DHLab Sales Order Confirmation"
{
    //Make the report searchable from Tell me under the Administration category.
    //UsageCategory = Administration;
    //ApplicationArea = All;
    //Caption="DHLab Sales Order Confirmation";
    //
    DefaultLayout = Word;
    // Specify the name of the file that the report will use for the layout.
    WordLayout = '50102_DHLab_Sales_Order_Confirmation.docx';
